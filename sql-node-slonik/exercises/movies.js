...
module.exports = {
    ...
    async q14() {
        return await db.query(sql`
        SELECT title,distributor,rating_imdb
        FROM movies
    ...
    async q23() {
        ...
        FROM movies
        WHERE production_budget <= 1000000 AND distributor = 'Sony Pictures'`)
    },
}